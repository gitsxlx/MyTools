...
public class BloomFilter implements Cloneable {
    ...
    /**
     * Test if the filters have equal bitsets. WARNING: two filters may contain the same elements,
     * but not be equal (if the filters have different size for example).
     */
    ...
    /**
     * Merge another bloom filter into the current one. After this operation, the current bloom
     * filter contains all elements in other.
     **/
