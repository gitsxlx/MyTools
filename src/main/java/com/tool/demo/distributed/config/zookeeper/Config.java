package com.tool.demo.distributed.config.zookeeper;
...
public class Config {
    ...
    public Config() {
        this.client = CuratorFrameworkFactory.newClient("localhost:2181", new RetryNTimes(3, 1));
        client.start();
            ...
            watcher.getListenable().addListener(new PathChildrenCacheListener() {
                ...
                public void childEvent(CuratorFramework client, PathChildrenCacheEvent event)
                    ...
                    if (path.startsWith(CONFIG_PREFIX)) {
                        ...
                        if (Type.CHILD_ADDED.equals(event.getType()) || Type.CHILD_UPDATED
                                .equals(event.getType()) || Type.CHILD_REMOVED
