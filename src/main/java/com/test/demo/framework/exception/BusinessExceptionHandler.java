package com.test.demo.framework.exception;

import com.test.demo.framework.constant.BusinessStatus;
import com.test.demo.framework.response.BaseResponse;
import com.test.demo.framework.util.ResultUtils;
...
public class BusinessExceptionHandler {
    ...
    public BaseResponse handleException(Exception e) {
        log.error("内部错误", e);
        return ResultUtils
                .fail(String.valueOf(HttpStatus.INTERNAL_SERVER_ERROR.value()), e.getMessage());
    }
