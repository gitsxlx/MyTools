package com.test.demo.framework.log;
...
/**
 * @program: MyTools
 * @description: 日志处理切面，处理被com.test.demo.framework.log.Log注解标记的方法
 * @author: Mr.Wang
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.test.demo.framework.log.Log)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        sb.append(lineSeparator).append("执行方法: ").append(className).append("#").append(methodName)
                .append("(");
        ...
        try {
            ...
            sb.append(lineSeparator).append("返回类型: ")
                    .append(ResolvableType.forMethodReturnType(method));
            sb.append(lineSeparator).append("返回内容: ")
                    .append(objectMapper.writeValueAsString(proceed));
